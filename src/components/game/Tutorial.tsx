          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-foreground leading-relaxed">
                Захватите все территории на карте. Побеждает тот, кто контролирует больше земель.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="text-sm text-foreground leading-relaxed space-y-2">
                <p>• Нажмите на свою территорию (с армией больше 1)</p>
                <p>• Выберите соседнюю территорию врага или нейтральную</p>
                <p>• Атака происходит автоматически</p>
                <p>• Если армия атакующего больше - территория захвачена</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-card border-4 border-border p-6 space-y-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="text-sm text-foreground leading-relaxed space-y-2">
                <p>• Каждая территория приносит доход золотом</p>
                <p>• Золото начисляется каждые 5 секунд</p>
                <p>• Чем больше территорий - тем больше доход</p>
                <p>• Используйте золото для найма армий (скоро)</p>
              </div>
            </div>
          </div>
        </div>
